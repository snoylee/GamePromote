...
public abstract class BaseIndicaorBanner<E, T extends BaseIndicaorBanner<E, T>> extends BaseBanner<E, T> {
    ...
    public BaseIndicaorBanner(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, com.xygame.sg.R.styleable.BaseIndicaorBanner);
        indicatorStyle = ta.getInt(com.xygame.sg.R.styleable.BaseIndicaorBanner_bib_indicatorStyle, STYLE_CORNER_RECTANGLE);
        indicatorWidth = ta.getDimensionPixelSize(com.xygame.sg.R.styleable.BaseIndicaorBanner_bib_indicatorWidth, dp2px(6));
        indicatorHeight = ta.getDimensionPixelSize(com.xygame.sg.R.styleable.BaseIndicaorBanner_bib_indicatorHeight, dp2px(6));
        indicatorGap = ta.getDimensionPixelSize(com.xygame.sg.R.styleable.BaseIndicaorBanner_bib_indicatorGap, dp2px(6));
        indicatorCornerRadius = ta.getDimensionPixelSize(com.xygame.sg.R.styleable.BaseIndicaorBanner_bib_indicatorCornerRadius, dp2px(3));
        selectColor = ta.getColor(com.xygame.sg.R.styleable.BaseIndicaorBanner_bib_indicatorSelectColor, Color.parseColor("#ffffff"));
        unselectColor = ta.getColor(com.xygame.sg.R.styleable.BaseIndicaorBanner_bib_indicatorUnselectColor, Color.parseColor("#88ffffff"));

        int selectRes = ta.getResourceId(com.xygame.sg.R.styleable.BaseIndicaorBanner_bib_indicatorSelectRes, 0);
        int unselectRes = ta.getResourceId(com.xygame.sg.R.styleable.BaseIndicaorBanner_bib_indicatorUnselectRes, 0);
        ta.recycle();
