...
public class PlaceChoiceMainActivity extends SGBaseActivity implements OnClickListener, OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.place_choice_main_layout);
        initViews();
        initListeners();
        initDatas();
    }
    ...
    private class InitDatas implements Runnable {
        ...
        public void run() {
            ...
            datas.add(1, tempMap.get(4));
            datas.add(1, tempMap.get(3));
            datas.add(1, tempMap.get(2));
            datas.add(1, tempMap.get(1));
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 0:
                    ...
                    adapter = new ProvinceMainAdater(PlaceChoiceMainActivity.this, datas);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Intent broadIntent=new Intent(XMPPUtils.UPDATE_MAIN_LOCATION);
        broadIntent.putExtra(Constants.COMEBACK, areaBean);
