 ...
 */
public class TempGroupMembersActivity extends SGBaseActivity implements View.OnClickListener, SideBar.OnTouchingLetterChangedListener {
    ...
    private void loadDatas() {
        ...
        try {
            ...
            obj.put("groupId", getIntent().getStringExtra("groupId"));
