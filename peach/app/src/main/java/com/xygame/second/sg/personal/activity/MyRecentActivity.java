...
import com.xygame.second.sg.personal.adapter.MyRecentAdapter;
 ...
 */
public class MyRecentActivity extends SGBaseActivity implements View.OnClickListener, PullToRefreshBase.OnRefreshListener2{
    ...
    private void initDatas() {
        ...
        adapter = new MyRecentAdapter(this, null);
    ...
    private void loadDatas() {
        ...
        try {
            ...
            if (isFristRequest){
                obj.put("firstAccess","1");
            }else{
                obj.put("firstAccess","2");
            }
        ...
        item.setServiceURL(ConstTaskTag.QUEST_USER_RECENTLY);
        ThreadPool.getInstance().excuseAction(this, item, ConstTaskTag.QUERY_USER_RECENTLY);
    }
    ...
    private Handler handler = new Handler() {
        public void handleMessage(android.os.Message msg) {
            switch (msg.what) {
                case 0:
                    Toast.makeText(MyRecentActivity.this,"已全部加载",Toast.LENGTH_SHORT).show();
    ...
    protected void getResponseBean(ResponseBean data) {
        switch (data.getPosionSign()) {
            case ConstTaskTag.QUERY_USER_RECENTLY:
                fansList.onRefreshComplete();
    ...
    private void parseFansModelDatas(ResponseBean data) {
        ...
        if (!TextUtils.isEmpty(resposeStr) && !"null".equals(resposeStr)) {
            ...
            try {
                ...
                String actions = object.getString("historys");
                if (ConstTaskTag.isTrueForArrayObj(actions)) {
                    ...
                    for (int i = 0; i < array2.length(); i++) {
                        ...
                        item.setVisitTime(StringUtils.getJsonValue(object1, "visitTime"));
                        datas.add(item);
                    }
                }
            } catch (Exception e) {
