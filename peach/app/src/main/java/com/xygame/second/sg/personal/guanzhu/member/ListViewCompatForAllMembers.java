...
import com.xygame.second.sg.utils.Utils;
import com.xygame.sg.R;

public class ListViewCompatForAllMembers extends ListView implements OnScrollListener {
    ...
    public ListViewCompatForAllMembers(Context context) {
        super(context);
        initView(context);
    }

    public ListViewCompatForAllMembers(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public ListViewCompatForAllMembers(Context context, AttributeSet attrs, int defStyle) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN: {
                ...
                if (position != INVALID_POSITION) {
                    GroupMemberBean data = (GroupMemberBean) getItemAtPosition(position);
                    if (data!=null){
