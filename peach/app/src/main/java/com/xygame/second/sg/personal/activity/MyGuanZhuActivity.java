...
import com.xygame.second.sg.personal.adapter.MyGuanZhuAdapter;
 ...
 */
public class MyGuanZhuActivity extends SGBaseActivity implements View.OnClickListener, PullToRefreshBase.OnRefreshListener2,FansAttetListener {
    ...
    private void initDatas() {
        ...
        adapter = new MyGuanZhuAdapter(this, null);
    ...
    private void loadDatas() {//index:1进行中 2已完成 3已关闭
        ...
        try {
            ...
            item.setData(obj);
            item.setServiceURL(ConstTaskTag.QUEST_USER_ATTENT);
            ThreadPool.getInstance().excuseAction(this, item, ConstTaskTag.QUERY_USER_ATTENT);
        } catch (Exception e1) {
            e1.printStackTrace();
        }
    }
    ...
    protected void getResponseBean(ResponseBean data) {
        switch (data.getPosionSign()) {
            case ConstTaskTag.QUERY_USER_ATTENT:
                fansList.onRefreshComplete();
