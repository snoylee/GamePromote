...
import com.xygame.sg.activity.notice.NoticeStatusActivity;
 ...
 * @action [模特编辑头像任务]
 */
public class LoadNoticeStatusTask extends NetWorkUtil {
	
	private NoticeStatusActivity activity;
	/**
	 * 重载方法
	 * 
	 * @param result
	...
	public Object run(String methodname, List<String> params, Param aparam) {
		// TODO Auto-generated method stub
		activity = ((NoticeStatusActivity) aparam.getActivity());
