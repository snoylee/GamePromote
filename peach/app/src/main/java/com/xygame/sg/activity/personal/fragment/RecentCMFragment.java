...
import com.xygame.sg.activity.personal.adapter.RecentCMAdapter;
...
public class RecentCMFragment extends RecentBaseFragment {
    private PullToRefreshListView listView;
    private RecentCMAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View mView = new ViewBinder(this.getActivity(), unit.setDisplay(this)).inflate(R.layout.fragment_recent_cm, null);
        initViews(mView);
    ...
    public  void responseRecentList(UserSeeHistoryView resultSeeHistoryView) {
        if (resultSeeHistoryView != null && resultSeeHistoryView.getHistorys() != null) {
            ...
            if (mCurrentPage > 1) {
                ...
                adapter = new RecentCMAdapter(getActivity(), seeHistoryView);
