 ...
 * @action  [用户日期修改]
 */
public class EditorUserProvince extends NetWorkUtil {
	
	private EditorProvinceActivity activity;
	/**
	 * 重载方法
	 * 
	 * @param result
	...
	public Object run(String methodname, List<String> params, Param aparam) {
		// TODO Auto-generated method stub
		activity = ((EditorProvinceActivity) aparam.getActivity());
		String province=activity.getProvinceCode();
		String city=activity.getCityCode();
