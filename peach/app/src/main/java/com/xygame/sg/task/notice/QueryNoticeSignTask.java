...
import com.xygame.sg.activity.notice.SignedActivity;
 ...
 * @action [模特编辑头像任务]
 */
public class QueryNoticeSignTask extends NetWorkUtil {
	
	private SignedActivity activity;
	/**
	 * 重载方法
	 * 
	 * @param result
	...
	public Object run(String methodname, List<String> params, Param aparam) {
		// TODO Auto-generated method stub
		activity = ((SignedActivity) aparam.getActivity());
		...
		try {
			...
			String shortStr=ob.toString();
			params.add("page="+shortStr);
		} catch (Exception e) {
