...
import com.xygame.sg.activity.personal.OrderResumeActivity;
 ...
 * @action [模特编辑头像任务]
 */
public class OrderUserResumeTask extends NetWorkUtil {
	
	private OrderResumeActivity activity;
	/**
	 * 重载方法
	 * 
	 * @param result
	...
	public Object run(String methodname, List<String> params, Param aparam) {
		// TODO Auto-generated method stub
		activity = ((OrderResumeActivity) aparam.getActivity());
