...
public class SGNoticeNewsMetaData {

	public static final String AUTHORIY = "com.xygame.sg.provider.SGNoticeNewsProvider";

	public static final class SGNoticeNewsTableMetaData implements BaseColumns {

		public static final String TABLE_NAME = "noticeNews";
		public static final Uri CONTENT_URI = Uri.parse("content://" + AUTHORIY
				+ "/noticeNews");
		public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.firstprovider.noticeNews";
		public static final String CONTENT_TYPE_ITEM = "vnd.android.cursor.item/vnd.firstprovider.noticeNews";
		...
		private SGNoticeNewsTableMetaData() {
		}
		...
		public static final String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME
				...
				+ " TEXT," + NOTICE_ID + " TEXT," + RECRUIT_ID + " TEXT," + NEW_TYPE + " TEXT," + OPERATOR_FLAG+ " TEXT);";
	}
}
