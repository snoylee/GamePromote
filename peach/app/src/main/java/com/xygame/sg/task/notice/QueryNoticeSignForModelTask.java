 ...
 * @action [模特编辑头像任务]
 */
public class QueryNoticeSignForModelTask extends NetWorkUtil {
	
	private SignedForModelActivity activity;
	/**
	 * 重载方法
	 * 
	 * @param result
	...
	public Object run(String methodname, List<String> params, Param aparam) {
		// TODO Auto-generated method stub
		activity = ((SignedForModelActivity) aparam.getActivity());
		String noticeId=activity.getnoticeId();
		String memberId=UserPreferencesUtil.getUserId(activity);
