 ...
 * @action [模特编辑头像任务]
 */
public class NoticeListForModelTask extends NetWorkUtil {
	
	private NoticeManagmentForModelActivity activity;
	/**
	 * 重载方法
	 * 
	 * @param result
	...
	public Object run(String methodname, List<String> params, Param aparam) {
		// TODO Auto-generated method stub
		activity = ((NoticeManagmentForModelActivity) aparam.getActivity());
