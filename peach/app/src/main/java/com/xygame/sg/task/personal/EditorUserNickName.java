 ...
 * @action  [用户日期修改]
 */
public class EditorUserNickName extends NetWorkUtil {
	
	private EditNickNameActivity activity;
	/**
	 * 重载方法
	 * 
	 * @param result
	...
	public Object run(String methodname, List<String> params, Param aparam) {
		// TODO Auto-generated method stub
		activity = ((EditNickNameActivity) aparam.getActivity());
		String nickStr=activity.getUserNick();
		params.add("userId="+UserPreferencesUtil.getUserId(activity));
		params.add("usernick="+nickStr);
