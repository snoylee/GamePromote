 ...
 * @action [模特编辑头像任务]
 */
public class SetPwdTask extends NetWorkUtil {
...
//			activity.resultInfo(map);
	...
	public Object run(String methodname, List<String> params, Param aparam) {
		// TODO Auto-generated method stub
		activity = ((SetPayPwdActivity) aparam.getActivity());
		String userId=UserPreferencesUtil.getUserId(activity);
		String password=activity.getNewPwd();
		params.add("userId="+userId);
		params.add("password="+password);
		params.add("rePassword="+password);
		params.add("type=1");
		ShowMsgDialog.show(activity, "密码设置中...", false);
