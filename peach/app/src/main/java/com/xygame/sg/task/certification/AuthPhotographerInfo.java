...
import com.xygame.sg.activity.personal.CMIdentySecondActivity;
...
public class AuthPhotographerInfo extends NetWorkUtil {
...
//        ShowMsgDialog.cancel();
        ...
        if (Constants.RESULT_CODE.equals(resultCode)) {
            ((CMIdentySecondActivity)aparam.getActivity()).finishUpload(aparam.getResultunit().getRawMap().get("record"));
        } else {
...
//        ShowMsgDialog.showNoMsg(aparam.getActivity(), false);
        CMIdentySecondActivity activity = ((CMIdentySecondActivity) aparam.getActivity());
