...
public class DeleteModelPrice extends NetWorkUtil {
	
	private DeleteCategoryActivity activity;
	...
	public Object run(String methodname, List<String> params, Param aparam) {
		...
		activity = ((DeleteCategoryActivity) aparam.getActivity());
		params.add("userId="+UserPreferencesUtil.getUserId(activity));
		params.add("deletePrices="+getJsonStr(activity.getDeleteDatas()));
