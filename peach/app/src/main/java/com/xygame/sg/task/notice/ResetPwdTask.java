...
import com.xygame.sg.activity.personal.ReSetPayPwdActivity;
import com.xygame.sg.activity.personal.SetPayPwdActivity;
 ...
 * @action [模特编辑头像任务]
 */
public class ResetPwdTask extends NetWorkUtil {

	private ReSetPayPwdActivity activity;
...
//			activity.resultInfo(map);
	...
	public Object run(String methodname, List<String> params, Param aparam) {
		// TODO Auto-generated method stub
		// TODO Auto-generated method stub
		activity = ((ReSetPayPwdActivity) aparam.getActivity());
