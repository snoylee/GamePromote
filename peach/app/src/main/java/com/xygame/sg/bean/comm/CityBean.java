 ...
 * @action  [城市实体]
 */
public class CityBean extends AssetDataBaseManager.CityBean implements Serializable{
	...
	public List<CityBean> getAreaBeans() {
		return areaBeans;
	}

	public void setAreaBeans(List<CityBean> areaBeans) {
