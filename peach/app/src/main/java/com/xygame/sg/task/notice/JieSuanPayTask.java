 ...
 * @action [模特编辑头像任务]
 */
public class JieSuanPayTask extends NetWorkUtil {

	private NoticeJieSuanActivity activity;
	...
	public Object run(String methodname, List<String> params, Param aparam) {
		// TODO Auto-generated method stub
		activity = ((NoticeJieSuanActivity) aparam.getActivity());
		...
		float amount=activity.getNeedPayPrice();
		if(amount>0){
