...
public class CommentActivity extends SGBaseActivity implements OnClickListener, TextWatcher {
	/**
	 * 公用变量部分
	 */
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(new ViewBinder(this, visitUnit).inflate(R.layout.comment_layout, null));
		InitImageView();
		initViews();
		initListensers();
		initDatas();
	...
	private void initViews() {
		...
		listViews.add(mInflater.inflate(R.layout.comment_sub_layout, null));
		listViews.add(mInflater.inflate(R.layout.comment_sub2_layout, null));
	...
	private void initDatas() {
		...
		commentFlag = getIntent().getStringExtra("commentFlag");
	...
	private void upLoadCommentsDatas() {
		...
		new Action("#.notice.UpLoadCommentsTask(${evaluateModel})", this, null, visit).run();
	}
	...
	private void loadCommentsDatas() {
		// TODO Auto-generated method stub
		VisitUnit visit = new VisitUnit();
		new Action("#.notice.LoadCommentsTask(${queryEvaluate})", this, null, visit).run();
	}
	...
	public void finishComments() {
		// TODO Auto-generated method stub
		Intent intent = new Intent("com.sg.finish.coment.action");
