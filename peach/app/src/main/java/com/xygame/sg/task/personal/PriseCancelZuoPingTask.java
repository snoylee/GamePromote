 ...
 * @action [请添加内容描述]
 */
public class PriseCancelZuoPingTask extends NetWorkUtil {

	private ImagePagerBrowersActivity activity;
	...
	public Object run(String methodname, List<String> params, Param aparam) {
		// TODO Auto-generated method stub
		activity = ((ImagePagerBrowersActivity) aparam.getActivity());
		String galId=activity.getGlaryId();
		String userId=activity.getSeeUserId();
		String seeUserId=activity.getResId();
		params.add("userId="+userId);
		params.add("galId="+galId);
		params.add("resId="+seeUserId);
