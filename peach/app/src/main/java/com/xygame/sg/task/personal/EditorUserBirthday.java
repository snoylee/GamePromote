 ...
 * @action  [用户日期修改]
 */
public class EditorUserBirthday extends NetWorkUtil {
	
	private EditorBirthdayActivity activity;
	/**
	 * 重载方法
	 * 
	 * @param result
	...
	public Object run(String methodname, List<String> params, Param aparam) {
		// TODO Auto-generated method stub
		activity = ((EditorBirthdayActivity) aparam.getActivity());
		String imageStr=activity.getBirthdayValue();
		params.add("userId="+UserPreferencesUtil.getUserId(activity));
		params.add("birthday="+imageStr);
