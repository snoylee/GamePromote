 ...
 * @action [作品相册页面]
 */
public class PlushNoticeNormalSuccessActivity extends SGBaseActivity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(new ViewBinder(this, visitUnit).inflate(R.layout.sg_plush_nomal_sucess_layout, null));
