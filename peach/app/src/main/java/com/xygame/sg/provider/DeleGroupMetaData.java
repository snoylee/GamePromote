...
public class DeleGroupMetaData {

	public static final String AUTHORIY = "com.xygame.sg.provider.DeleGroupProvider";

	public static final class GroupTableMetaData implements BaseColumns {

		public static final String TABLE_NAME = "deleGroupTable";
		public static final Uri CONTENT_URI = Uri.parse("content://" + AUTHORIY
				+ "/deleGroupTable");
		public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.firstprovider.deleGroupTable";
		public static final String CONTENT_TYPE_ITEM = "vnd.android.cursor.item/vnd.firstprovider.deleGroupTable";
