...
import com.xygame.sg.activity.personal.SettingOpinionActivity;
...
public class QueryFeedbackServicePhone extends NetWorkUtil {
	...
	public void callback(Param aparam, Object object) {
		...
		if (Constants.RESULT_CODE.equals(resultCode)) {
			...
			SettingOpinionActivity activity =(SettingOpinionActivity) aparam.getActivity();
