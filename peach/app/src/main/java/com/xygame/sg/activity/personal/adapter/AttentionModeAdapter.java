 ...
 */
public class AttentionModeAdapter extends BaseAdapter {
    ...
    public AttentionModeAdapter(Context context, List<AttentUserView> attentions) {
        super();
...
//        holder.price_tv.setText("￥"+attention.getPrice()/100);
