...
public class TwoButtonTextDialog extends Dialog implements View.OnClickListener {
    ...
    public TwoButtonTextDialog(Context context, int attrsr) {
        super(context, attrsr);
    }

    public TwoButtonTextDialog(Context context,String dialogTitleStr, String textTip, int attrs, ButtonTwoTextListener listener) {
        super(context, attrs);
    ...
    public TwoButtonTextDialog(Context context,String dialogTitleStr, String textTip, String comfirmViewText, String cancelViewText, int attrs, ButtonTwoTextListener listener) {
        super(context, attrs);
        this.listener = listener;
        this.textTip = textTip;
        this.dialogTitleStr=dialogTitleStr;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.two_button_text_dialog_layout);
        initViews();
        initListener();
        initDatas();
    }
