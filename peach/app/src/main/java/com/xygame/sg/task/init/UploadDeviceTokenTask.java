 ...
 * @action [请求阿里参数]
 */
public class UploadDeviceTokenTask extends NetWorkUtil {
	/**
	 * 重载方法
	 * 
	 * @param result
	...
	public Object run(String methodname, List<String> params, Param aparam) {
		// TODO Auto-generated method stub
		MainFrameActivity activity=(MainFrameActivity) aparam.getActivity();
		String userId=UserPreferencesUtil.getUserId(activity);
		String deviceToken=activity.getRegistrationId();
