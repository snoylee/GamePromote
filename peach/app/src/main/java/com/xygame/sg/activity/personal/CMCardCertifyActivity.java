...
public class CMCardCertifyActivity extends SGBaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cm_card_certify);
        initViews();
        initDatas();
        addListener();
    }
    ...
    private void doUploadImages() {
        ...
        AliySSOHepler.getInstance().uploadImageEngine(this, Constants.VERIFICATION_PATH, picPaths.get(0), new HttpCallBack() {
...
//                        finish();
    ...
    private void uploadIdInfo() {
        ...
        try {
            ...
            obj.put("cardUrl", identyTranBean.getFrontUrl());
            item.setData(obj);
        } catch (Exception e1) {
            e1.printStackTrace();
        }
        item.setServiceURL(ConstTaskTag.QUEST_CERTIFY_CARD);
        ThreadPool.getInstance().excuseAction(this, item, ConstTaskTag.QUERY_CERTIFY_CARD);
    }
    ...
    protected void getResponseBean(ResponseBean data) {
        ...
        switch (data.getPosionSign()) {
            case ConstTaskTag.QUERY_CERTIFY_CARD:
                if ("0000".equals(data.getCode())) {
                    UserPreferencesUtil.setUserCardAuth(this,"4");
                    finish();
                } else {
                    Toast.makeText(CMCardCertifyActivity.this, data.getMsg(), Toast.LENGTH_SHORT).show();
                }
                break;
        }
    }
        ...
        TwoButtonDialog dialog = new TwoButtonDialog(this, content, leftText, rightText, R.style.dineDialog,
                new ButtonTwoListener() {
                    ...
                    public void confrimListener() {
                        Intent intent = new Intent(CMCardCertifyActivity.this, VideoCertifyActivity.class);
            ...
            if (Constants.IMAGE_BROADCAST_LISTENER.equals(intent.getAction())) {
                ...
                if (result != null) {
                    ...
                    for (int i = 0; i < tempStrs.size(); i++) {
                        ...
                        if (subBitmap != null) {
                            String photoName = Constants.getImageName(CMCardCertifyActivity.this);
...
//        }
        ...
        if (StringUtils.isEmpty(identyTranBean.getFrontPath())) {
            Toast.makeText(this, "请上您的名片！", Toast.LENGTH_SHORT).show();
            return;
        }
//        if (StringUtils.isEmpty(identyTranBean.getBackPath())) {
