...
//    private ImageLoader imageLoader;
    ...
    public CMNoticeAdapter(Context context, NoticeListBean noticeList,ModelDataVo modelDataVo, boolean isQuery) {
        super();
...
//    }
    ...
    public int getCount() {
        if (noticeList!=null && noticeList.getNotices() != null  ) {
            return noticeList.getNotices().size()+1;
        }
        return 0;
    }
...
//                    if (i ==0){
//                        layoutParamsLl.setMargins(DataTools.dip2px(context, 10), DataTools.dip2px(context, 20), DataTools.dip2px(context, 10), 0);//4个参数按顺序分别是左上右下
...
//                }
                ...
                NoticeListVo noticeListVo = noticeList.getNotices().get(i-1);
