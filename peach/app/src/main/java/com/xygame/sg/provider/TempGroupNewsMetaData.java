...
public class TempGroupNewsMetaData {

	public static final String AUTHORIY = "com.xygame.sg.provider.TempGroupNewsProvider";

	public static final class TempGroupTableMetaData implements BaseColumns {

		public static final String TABLE_NAME = "temp_group";
		public static final Uri CONTENT_URI = Uri.parse("content://" + AUTHORIY
				+ "/temp_group");
		public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.firstprovider.temp_group";
		public static final String CONTENT_TYPE_ITEM = "vnd.android.cursor.item/vnd.firstprovider.temp_group";
		...
		private TempGroupTableMetaData() {
		}
