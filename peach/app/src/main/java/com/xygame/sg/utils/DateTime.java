...
//    public static final String SLASH_DATE_TIME_HHmm_FORMAT_PATTERN = "yyyy\\MM\\dd HH:mm";
    ...
    public static String getLimitTimeStr(long limitTime) {
        limitTime = limitTime / 1000;
        long day = limitTime / (24 * 60 * 60);
        long hours =  (limitTime % (24 * 60 * 60)) / (60 * 60);
        long minutes = ((limitTime % (24 * 60 * 60)) % (60 * 60)) / 60;
        String dayStr = String.valueOf(day);
        String hoursStr = String.valueOf(hours);
        String minutesStr = String.valueOf(minutes);
        return dayStr + "天" + hoursStr + "小时" + minutesStr + "分";
    }
