 ...
 * @action [模特编辑头像任务]
 */
public class LoadComplaintTypesTask extends NetWorkUtil {
	
	private ReportFristActivity activity;
	/**
	 * 重载方法
	 * 
	 * @param result
...
//			activity.finishLoadTypes(listMap);
		}
	...
	public Object run(String methodname, List<String> params, Param aparam) {
		// TODO Auto-generated method stub
		activity = ((ReportFristActivity) aparam.getActivity());
