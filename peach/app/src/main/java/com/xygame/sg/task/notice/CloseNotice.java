...
public class CloseNotice extends NetWorkUtil {
	...
	public void callback(Param aparam, Object object) {
		...
		if (Constants.RESULT_CODE.equals(resultCode)) {
			NoticeCloseActivity noticeCloseActivity = (NoticeCloseActivity) aparam.getActivity();
			noticeCloseActivity.responseClose();
		}else {
