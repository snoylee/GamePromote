...
import com.xygame.sg.activity.personal.adapter.CMWorkAdapter;
...
public class CMWorkTabFragment extends ScrollTabHolderFragment implements View.OnClickListener {

    private PullToRefreshListView listView;

    private View placeHolderView;

    private CMWorkAdapter workAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        isPrepared = true;
        return inflater.inflate(R.layout.fragment_cm_work_tab, null);
    }
...
//            dataList = resultList;
//            workAdapter = new CMWorkAdapter(getActivity(),dataList,userId,isQuery);
...
//    public void responseHandler(List<Map> resultList) {
//        if (listView.isRefreshing()) {
//            listView.onRefreshComplete();
//        }
//        if (!resultList.isEmpty()) {
...
//        int leftH = spaceH -h;
//        Log.i("^^^^^^1",statusbarH+"   "+  screenH+"    "+spaceH+"  "+leftH);
//        if (leftH > 0 && addFootViewNum==0) {
//
