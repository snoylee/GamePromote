 ...
 * @action [模特编辑头像任务]
 */
public class UpLoadCommentsForModelTask extends NetWorkUtil {
	
	private CommentForModelActivity activity;
	/**
	 * 重载方法
	 * 
	 * @param result
	...
	public Object run(String methodname, List<String> params, Param aparam) {
		// TODO Auto-generated method stub
		activity = ((CommentForModelActivity) aparam.getActivity());
		...
		params.add("noticeLevel="+picLevel);
		params.add("pgExperLevel="+experienceLevel);
		params.add("payLevel="+coordinateLevel);
