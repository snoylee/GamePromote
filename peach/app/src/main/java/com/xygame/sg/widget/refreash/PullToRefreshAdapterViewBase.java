...
import com.xygame.sg.activity.personal.adapter.AlbumCoverAdapter;
...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
	...
	public void setAdapter1(BaseAdapter adapter) {
//		((AdapterView<ListAdapter>) mRefreshableView).setAdapter(adapter);

		AlphaInAnimationAdapter alphaInAnimationAdapter = new AlphaInAnimationAdapter(adapter);
		alphaInAnimationAdapter.setAbsListView( (mRefreshableView));
		mRefreshableView.setAdapter(alphaInAnimationAdapter);
