...
public class JJRIdentyFirstActivity extends SGBaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(new ViewBinder(this, visitUnit).inflate(R.layout.activity_jjridenty_first, null));
        initViews();
        initDatas();
        addListener();
    }
...
//                        finish();
    ...
    public void commitJJRDatas(){
        ...
        try {
            ...
            obj.put("picCardHold",identyTranBean.getHalfUrl());
        ...
        item.setServiceURL(ConstTaskTag.QUEST_JJR_VERIFY);
        ThreadPool.getInstance().excuseAction(this, item, ConstTaskTag.RESPOSE_JJR_VERIFY);
    }
    ...
    protected void responseFaith(ResponseBean data) {
        ...
        showDialog("认证提交失败，是否重新提交认证？");
    }

    private void showDialog(String tip){
        TwoButtonDialog dialog = new TwoButtonDialog(this, tip, "重新提交","退出认证",R.style.dineDialog,
                ...
                if (Constants.IMAGE_BROADCAST_LISTENER.equals(intent
                    ...
                    if (result != null) {
                        ...
                        for (int i = 0; i < tempStrs.size(); i++) {
                            ...
                            if (subBitmap != null) {
                                String photoName = Constants.getImageName(JJRIdentyFirstActivity.this);
