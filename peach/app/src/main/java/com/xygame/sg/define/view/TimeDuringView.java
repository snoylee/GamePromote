 ...
 * @action [选择拍照或相册的界面]
 */
public class TimeDuringView extends SGBaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.time_during_layout);
		...
		findViewById(R.id.fourButton).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent intent = new Intent();
				intent.putExtra(Constants.COMEBACK,4);
				intent.putExtra("flag","半天（4小时）");
				setResult(Activity.RESULT_OK, intent);
				finish();
			}
		});
