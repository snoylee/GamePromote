...
public class SGGodNewsMetaData {

	public static final String AUTHORIY = "com.xygame.sg.provider.SGGodNewsProvider";

	public static final class SGNewsTableMetaData implements BaseColumns {

		public static final String TABLE_NAME = "newsGod";
		public static final Uri CONTENT_URI = Uri.parse("content://" + AUTHORIY
				+ "/newsGod");
		public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.firstprovider.newsGod";
		public static final String CONTENT_TYPE_ITEM = "vnd.android.cursor.item/vnd.firstprovider.newsGod";
