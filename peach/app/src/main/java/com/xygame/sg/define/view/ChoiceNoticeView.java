 ...
 * @action [选择拍照或相册的界面]
 */
public class ChoiceNoticeView extends SGBaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.select_notice_pop);
		...
		findViewById(R.id.galary).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent intent = new Intent();
				intent.putExtra(Constants.COMEBACK, "galary");
				setResult(Activity.RESULT_OK, intent);
				finish();
			}
		});
		findViewById(R.id.camera).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent intent = new Intent();
				intent.putExtra(Constants.COMEBACK,"camera");
				setResult(Activity.RESULT_OK, intent);
				finish();
			}
		});
