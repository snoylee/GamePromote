...
public class ToCloseNotice extends NetWorkUtil {
	...
	public void callback(Param aparam, Object object) {
		...
		if (Constants.RESULT_CODE.equals(resultCode)) {
			...
			NoticeCloseActivity activity = (NoticeCloseActivity) aparam.getActivity();
//			String jsonStr = JSON.toJSONString(aparam.getResultunit().get("record"));
//			NoticeCloseVo toCloseNotice = JSONPObject.parseObject(jsonStr, NoticeCloseVo.class);
//			activity.responseToClose(toCloseNotice);
		} else {
