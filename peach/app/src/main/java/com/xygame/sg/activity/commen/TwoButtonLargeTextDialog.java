...
public class TwoButtonLargeTextDialog extends Dialog implements View.OnClickListener {
    ...
    public TwoButtonLargeTextDialog(Context context, int attrsr) {
        super(context, attrsr);
    }

    public TwoButtonLargeTextDialog(Context context, String dialogTitleStr, String textTip, int attrs, ButtonTwoTextListener listener) {
        super(context, attrs);
    ...
    public TwoButtonLargeTextDialog(Context context, String dialogTitleStr, String textTip, String comfirmViewText, String cancelViewText, int attrs, ButtonTwoTextListener listener) {
        super(context, attrs);
        this.listener = listener;
        this.textTip = textTip;
        this.dialogTitleStr=dialogTitleStr;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.two_button_largetext_dialog_layout);
        initViews();
        initListener();
        initDatas();
    }
