...
public class NewsGodEngine {

	public static void inserChatNew(Context context, SGNewsBean item) {
		ContentValues values = new ContentValues();
		values.put(SGGodNewsMetaData.SGNewsTableMetaData.USER_ID, item.getUserId());
		values.put(SGGodNewsMetaData.SGNewsTableMetaData.FRIEND_USERID, item.getFriendUserId());
		values.put(SGGodNewsMetaData.SGNewsTableMetaData.IS_SHOW, item.getIsShow());
		values.put(SGGodNewsMetaData.SGNewsTableMetaData.MESSAGE_STATUS, item.getMessageStatus());
		values.put(SGGodNewsMetaData.SGNewsTableMetaData.MSG_STATUS, item.getMsgStatus());
		values.put(SGGodNewsMetaData.SGNewsTableMetaData.MESSAGE_CONTENT, item.getMsgContent());
		values.put(SGGodNewsMetaData.SGNewsTableMetaData.TYPE, item.getType());
		values.put(SGGodNewsMetaData.SGNewsTableMetaData.FROM_USER, item.getFromUser());
		values.put(SGGodNewsMetaData.SGNewsTableMetaData.TO_USER, item.getToUser());
		values.put(SGGodNewsMetaData.SGNewsTableMetaData.NOTICE_SUBJECT, item.getNoticeSubject());
		values.put(SGGodNewsMetaData.SGNewsTableMetaData.RECRUIT_LOCAL_INDEX, item.getRecruitLocIndex());
		values.put(SGGodNewsMetaData.SGNewsTableMetaData.IN_OUT, item.getInout());
		values.put(SGGodNewsMetaData.SGNewsTableMetaData.TIMESTAMP, item.getTimestamp());
		values.put(SGGodNewsMetaData.SGNewsTableMetaData.NOTICE_ID, item.getNoticeId());
		values.put(SGGodNewsMetaData.SGNewsTableMetaData.RECRUIT_ID, item.getRecruitId());
		values.put(SGGodNewsMetaData.SGNewsTableMetaData.NEW_TYPE, item.getNewType());
		context.getContentResolver().insert(SGGodNewsMetaData.SGNewsTableMetaData.CONTENT_URI, values);
	}
	...
	public static List<SGNewsBean> quaryChatNews(Context context, String userId) {
		List<SGNewsBean> lists = new ArrayList<SGNewsBean>();
		SGNewsBean item;
		Cursor c = context.getContentResolver().query(SGGodNewsMetaData.SGNewsTableMetaData.CONTENT_URI,
				new String[]{SGGodNewsMetaData.SGNewsTableMetaData._ID, SGGodNewsMetaData.SGNewsTableMetaData.USER_ID,
						SGGodNewsMetaData.SGNewsTableMetaData.IS_SHOW, SGGodNewsMetaData.SGNewsTableMetaData.IN_OUT,
						SGGodNewsMetaData.SGNewsTableMetaData.MESSAGE_STATUS,
						SGGodNewsMetaData.SGNewsTableMetaData.MSG_STATUS,
						SGGodNewsMetaData.SGNewsTableMetaData.MESSAGE_CONTENT, SGGodNewsMetaData.SGNewsTableMetaData.TYPE,
						SGGodNewsMetaData.SGNewsTableMetaData.FROM_USER, SGGodNewsMetaData.SGNewsTableMetaData.TO_USER,
						SGGodNewsMetaData.SGNewsTableMetaData.NOTICE_SUBJECT,
						SGGodNewsMetaData.SGNewsTableMetaData.RECRUIT_LOCAL_INDEX,
						SGGodNewsMetaData.SGNewsTableMetaData.TIMESTAMP, SGGodNewsMetaData.SGNewsTableMetaData.NOTICE_ID,
						SGGodNewsMetaData.SGNewsTableMetaData.RECRUIT_ID, SGGodNewsMetaData.SGNewsTableMetaData.NEW_TYPE},
				"newType=? and userId=? and isShow=?",
				new String[]{Constants.NEWS_CHAT, userId, Constants.NEWS_SHOW},
				SGGodNewsMetaData.SGNewsTableMetaData.DEFAULT_SORT_DESC);
		for (c.moveToFirst(); !(c.isAfterLast()); c.moveToNext()) {
			item = new SGNewsBean();
			item.setIsShow(c.getString(c.getColumnIndex(SGGodNewsMetaData.SGNewsTableMetaData.IS_SHOW)));
			item.set_id(c.getString(c.getColumnIndex(SGGodNewsMetaData.SGNewsTableMetaData._ID)));
			item.setMsgStatus(c.getString(c.getColumnIndex(SGGodNewsMetaData.SGNewsTableMetaData.MSG_STATUS)));
			item.setInout(c.getString(c.getColumnIndex(SGGodNewsMetaData.SGNewsTableMetaData.IN_OUT)));
			item.setFromUser(c.getString(c.getColumnIndex(SGGodNewsMetaData.SGNewsTableMetaData.FROM_USER)));
			item.setToUser(c.getString(c.getColumnIndex(SGGodNewsMetaData.SGNewsTableMetaData.TO_USER)));
			item.setNoticeSubject(c.getString(c.getColumnIndex(SGGodNewsMetaData.SGNewsTableMetaData.NOTICE_SUBJECT)));
			item.setRecruitLocIndex(
					c.getString(c.getColumnIndex(SGGodNewsMetaData.SGNewsTableMetaData.RECRUIT_LOCAL_INDEX)));
			item.setMsgContent(c.getString(c.getColumnIndex(SGGodNewsMetaData.SGNewsTableMetaData.MESSAGE_CONTENT)));
			item.setNewType(c.getString(c.getColumnIndex(SGGodNewsMetaData.SGNewsTableMetaData.NEW_TYPE)));
			item.setNoticeId(c.getString(c.getColumnIndex(SGGodNewsMetaData.SGNewsTableMetaData.NOTICE_ID)));
			item.setRecruitId(c.getString(c.getColumnIndex(SGGodNewsMetaData.SGNewsTableMetaData.RECRUIT_ID)));
			item.setTimestamp(c.getString(c.getColumnIndex(SGGodNewsMetaData.SGNewsTableMetaData.TIMESTAMP)));
			item.setType(c.getString(c.getColumnIndex(SGGodNewsMetaData.SGNewsTableMetaData.TYPE)));
			item.setUserId(c.getString(c.getColumnIndex(SGGodNewsMetaData.SGNewsTableMetaData.USER_ID)));
			item.setMessageStatus(c.getString(c.getColumnIndex(SGGodNewsMetaData.SGNewsTableMetaData.MESSAGE_STATUS)));
			if (!UserPreferencesUtil.getUserId(context).equals(SenderUser.getFromUserId(item, context))) {
				item.setFriendUserIcon(SenderUser.getFromUserIcon(item, context));
				item.setFriendUserId(SenderUser.getFromUserId(item, context));
				item.setFriendNickName(SenderUser.getFromUserName(item, context));
	...
	public static List<SGNewsBean> quaryChatHistory(Context context, SGNewsBean sgBean, String userId) {
		...
		Cursor c = context.getContentResolver().query(SGGodNewsMetaData.SGNewsTableMetaData.CONTENT_URI,
				...
				SGGodNewsMetaData.SGNewsTableMetaData.DEFAULT_SORT_ORDER);
		for (c.moveToFirst(); !(c.isAfterLast()); c.moveToNext()) {
			item = new SGNewsBean();
			item.setIsShow(c.getString(c.getColumnIndex(SGGodNewsMetaData.SGNewsTableMetaData.IS_SHOW)));
			item.set_id(c.getString(c.getColumnIndex(SGGodNewsMetaData.SGNewsTableMetaData._ID)));
...
//			}
	...
	public static void deleteDynamicNew(Context context, SGNewsBean item,
										String userId) {
		context.getContentResolver().delete(
				SGGodNewsMetaData.SGNewsTableMetaData.CONTENT_URI,
	...
	public static void updateDynamicStatus(Context context, String userId) {
		ContentValues values = new ContentValues();
		values.put(SGGodNewsMetaData.SGNewsTableMetaData.MESSAGE_STATUS, Constants.NEWS_READ);
		context.getContentResolver().update(SGGodNewsMetaData.SGNewsTableMetaData.CONTENT_URI, values,
				"newType=? and userId=?",
				new String[]{Constants.NEWS_DYNAMIC, userId});
	}
