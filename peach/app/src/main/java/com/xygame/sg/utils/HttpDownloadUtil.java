...
public class HttpDownloadUtil {
    private static HttpDownloadUtil instance;
...
*/
     ...
     * @return
*/
    public int downFile(String urlstr,String fileDir,String fileName){
        InputStream inputStream=null;
        FileDownUtils fileUtils=new FileDownUtils(fileDir);
        
        if(fileUtils.isFileExist(fileName)){
            return 1;
        }else{
            inputStream=getInputStreamFormUrl(urlstr);
            File resultFile=fileUtils.writeToSDfromInput(fileName, inputStream);
            if(resultFile==null){
                return -1;
            }
        }
