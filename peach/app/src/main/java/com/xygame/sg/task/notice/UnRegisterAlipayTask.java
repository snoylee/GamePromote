...
import com.xygame.sg.activity.personal.UnBangDialogActivity;
 ...
 * @action [模特编辑头像任务]
 */
public class UnRegisterAlipayTask extends NetWorkUtil {
	
	private UnBangDialogActivity activity;
	/**
	 * 重载方法
	 * 
	 * @param result
...
//				activity.unBangInfo();
	...
	public Object run(String methodname, List<String> params, Param aparam) {
		// TODO Auto-generated method stub
		activity = ((UnBangDialogActivity) aparam.getActivity());
		String userId=UserPreferencesUtil.getUserId(activity);
		String password=activity.getPwd();
