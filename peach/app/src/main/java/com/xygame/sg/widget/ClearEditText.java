...
/**
 * 增加删除所输入内容的按钮，并且可以输入136 0379 2246格式的电话号码
 * @author yingsoft
 *
 */
public class ClearEditText extends EditText implements  OnFocusChangeListener {
	...
	private void init(Context context, AttributeSet attrs) { 
        ...
        TypedArray a = context 
                .obtainStyledAttributes(attrs, R.styleable.clearEditTextAttr);
        showMobileType = a.getBoolean(R.styleable.clearEditTextAttr_showMobileType, false); 
        a.recycle(); // 回收资源 
		//获取EditText的右边的删除按钮
		mClearDrawable = getCompoundDrawables()[2]; 
		if (mClearDrawable == null) { 
			mClearDrawable = getResources().getDrawable(R.drawable.et_clear_selector); 
		} 
