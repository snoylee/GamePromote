 ...
 */
public class IRangeSeekBar extends RangeSeekBar {

    public IRangeSeekBar(Integer absoluteMinValue, Integer absoluteMaxValue, Context context, AttributeSet attr) throws IllegalArgumentException {
    ...
    public IRangeSeekBar(Context context, AttributeSet attrs) {
    ...
    public IRangeSeekBar setVisitUnit(VisitUnit visitUnit) {
