...
public class TiXianActivityForModel extends SGBasePaymentActivity implements OnClickListener {
	/**
	 * 公用变量部分
	 */
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(new ViewBinder(this, visitUnit).inflate(R.layout.tixian_model_layout, null));
		initViews();
		initListensers();
		initDatas();
	}
	...
	private void initDatas() {
		...
		String tixian="￥".concat(String.valueOf(Long.parseLong(qBean.getAmount())/100));
	...
	private void commitPay() {
		...
		new Action("#.notice.TiXianPayForModelTask(${cash})", this, null, visit).run();
	}
