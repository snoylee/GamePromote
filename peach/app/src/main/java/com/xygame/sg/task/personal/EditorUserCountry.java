 ...
 * @action  [用户日期修改]
 */
public class EditorUserCountry extends NetWorkUtil {
	
	private EditorCountryActivity activity;
	/**
	 * 重载方法
	 * 
	 * @param result
	...
	public Object run(String methodname, List<String> params, Param aparam) {
		// TODO Auto-generated method stub
		activity = ((EditorCountryActivity) aparam.getActivity());
		String cname=activity.getCountryName();
		params.add("userId="+UserPreferencesUtil.getUserId(activity));
		params.add("country="+cname);
